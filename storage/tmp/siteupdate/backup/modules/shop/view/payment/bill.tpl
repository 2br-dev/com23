...
<body>
<div class="bill__header" style="width: 100%; text-align: center; margin-bottom: 0px;">
    <img style="max-width: 100%;" src="{$THEME_IMG}/bill-header.jpg">
</div>
<table width="100%">
    <tr>
        <td>&nbsp;</td>
...
<div class="bill__attention" style="width: 100%;text-align: center;">
    <p style="font-size: 16px;font-weight: bold;color: #000000;text-transform: uppercase;padding: 5px 10px;border: 3px solid red; display: inline-block;">При оплате счета обязательно указывайте ИНН плательщика</p>
</div>
