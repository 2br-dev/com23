        ...
        <div class="o-leftcol">
            ...
            <div class="bordered userBlock">
                ...
                <div>
                    ...
                    <p style="color: red; font-weight: bold; font-size: 16px; margin-top: 20px; border-top: 1px solid grey; padding-top: 20px;">{$elem.comments}</p>
                    ...
                    {hook name="shop-orderview:info" title=t('Редактирование заказа(админ. панель):Блок с информацией')}
                        <table class="otable">
                             <tr>
                                ...
                                <td style="color: red; font-weight: bold; font-size: 14px;">{$elem.comments}</td>
                            </tr>
                            <tr>
                                <td class="otitle">
                                    {t}Номер{/t}
