<?php
require($_SERVER['DOCUMENT_ROOT'].'/setup.inc.php');
include 'config.php';
...
class TinyImageManager {
	...
	function TinyImageManager() {
        ...
        //Для загрузки изображений нужны права на запись для системного модуля
        $has_write_right = \RS\AccessControl\Rights::CheckRightError('main', ACCESS_BIT_WRITE) === false;
