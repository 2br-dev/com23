                    ...
                    {if count($address_list)>0}
                        <div class="formLine lastAddress">
                            ...
                            <div class="addressItem">
                                ...
                                {if $address.is_remote_region}
                                    <p style="display: inline-block; vertical-align: middle; color: red;"> - Особые условия доставки</p>
                                    <a class="help-icon" title="Стоимость одной бутылки воды, с доставкой на указанный адрес, выше на 10 рублей">?</a>
                                {/if}
                                {if $address.is_discount_region}
                                    <p style="display: inline-block; vertical-align: middle; color: red;"> - Льготный адрес</p>
                                {/if}
                                <a href="{$router->getUrl('shop-front-checkout', ['Act' =>'deleteAddress', 'id' => $address.id])}" class="deleteAddress" alt="Удалить адресс" title="Удалить адресс"/></a>
                                <br>
                            </div>
                            {/foreach}
                            <div class="addressItem">
