<form method="POST" action="{$router->getUrl('users-front-auth')}" class="authorization formStyle">
    ...
    {$this_controller->myBlockIdInput()}
        <div class="forms">
            ...
            <div class="center">
                <div class="formLine">
                    <label class="fieldName">E-mail или Логин</label>
                ...
                {moduleinsert name="\SocialAuth\Controller\Block\AuthBlock" vkontakte=1 odnoklassniki=1 mailru=1 facebook=1 twitter=1 google=1 yandex=1} 
            </div>
            <div class="underLine">
