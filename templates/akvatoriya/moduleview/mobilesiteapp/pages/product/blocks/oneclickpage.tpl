<div class="buyOneClickCartWrapper" margin>
  <div class="oneClickCart">
    {hook name="mobilesiteapp-blocksoneclickpage:oneclickpage" title="{t}Мобильное приложение - купить в один клик:блок, купить в один клик{/t}"}
      {literal}
      <ion-list>
        ...
        <ion-item>
          ...
          <ion-input type="tel" class="phone" [(ngModel)]="phone" [value]="phone"></ion-input>
        </ion-item>
    ...
    <div padding-vertical text-center>
      Нажимая на кнопку "Отправить" я даю своё <a href="https://com23.ru/user-policy/" target="_blank">согласие на обработку персональных данных</a>.
    </div>
