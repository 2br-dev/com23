            ...
            <div class="productActionsWrapper" *ngIf="isOffersLoaded()">
                ...
                <div class="productCost" text-center text-md-left margin-bottom>
                    <ng-template [ngIf]="product.isShowMorePrice()">
                        <div class="costValuesWrapper">
                            <div class="costValues">
                                <div class="costItem">
                                    <div class="costTitle">за 1</div>
                                    <div class="costOne">{{product.getCost()}}</div>
                                </div>
                                <div class="costItem">
                                    <div class="costTitle">от 2-х</div>
                                    <div class="costOne">{{product.getCost('Цена от 2-х бутылей')}}</div>
                                </div>
                                <div class="costItem">
                                    <div class="costTitle">от 4-х</div>
                                    <div class="costOne">{{product.getCost('Цена от 4-х бутылей')}}</div>
                                </div>
                            </div>
                            <div class="help">
                ...
                <ion-grid class="productButtons">
                    {if $shop_config}
                    <ion-row *ngIf="isBuyButtonShow() && (product['maindir'] != 4)">
                        <ion-col col-8 offset-2 offset-md-0>
                            <button text-capitalize block ion-button round color="orange" class="app_btn" tappable (click)="addToCart()">В корзину</button>
                        </ion-col>
                    </ion-row>
                    <ion-row *ngIf="isReservationButtonShow() && (product['maindir'] != 4)">
                        <ion-col col-8 offset-2 offset-md-0>
                    ...
                    <ion-row *ngIf="isBuyOneClickShow() && (product['maindir'] != 4)">
                        <ion-col col-8 offset-2 offset-md-0>
