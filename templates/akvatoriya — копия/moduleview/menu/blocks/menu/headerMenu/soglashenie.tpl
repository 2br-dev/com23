...
<h1>Пользовательское соглашение</h1>
	...
	<div class="block100 text-for-ekvaring">
		<p>г. Краснодар  «22» декабря 2016 г. 

<p><span>1. ОБЩИЕ ПОЛОЖЕНИЯ</span></p>

<p>1.1.   Настоящее Пользовательское соглашение (далее – Соглашение) относится к сайту Интернет-магазина «Единая служба доставки питьевой воды», расположенному по адресу com23.ru</p>

<p>1.2.   Сайт Интернет-магазина «Единая служба доставки питьевой воды»  (далее – Сайт) является собственностью Общества с ограниченной ответственностью «Акватория».

<p>1.3.   Настоящее Соглашение регулирует отношения между Администрацией сайта Интернет-магазина «Единая служба доставки питьевой воды» com23.ru  (далее – Администрация сайта) и Пользователем данного Сайта.

<p>1.4. Администрация сайта оставляет за собой право в любое время изменять, добавлять или удалять пункты настоящего Соглашения без уведомления Пользователя.
...
<p><span>2.   ОПРЕДЕЛЕНИЯ ТЕРМИНОВ</span></p>

 

<p>2.1.   Перечисленные ниже термины имеют для целей настоящего Соглашения следующее значение:</p>

<p>2.1.1 «Единая служба доставки питьевой воды» – Интернет-магазин, расположенный на доменном имени com23.ru , осуществляющий свою деятельность посредством Интернет-ресурса и сопутствующих ему сервисов.</p>
...
<p>2.1.3. Администрация сайта Интернет-магазина – уполномоченные сотрудники на управления Сайтом, действующие от имени ООО “Акватория”.</p>
...
<p><span>3.   ПРЕДМЕТ СОГЛАШЕНИЯ</span></p>
...
<p>3.1.2. Под действие настоящего Соглашения попадают все существующие (реально функционирующие) на данный момент услуги (сервисы) Интернет-магазина, а также любые их последующие модификации и появляющиеся в дальнейшем дополнительные услуги (сервисы) Интернет-магазина.</p>

<p>3.2. Доступ к Интернет-магазину предоставляется на бесплатной основе основе(возможна оплата услуг доступа к сети Интернет, взимаемая с Пользователя поставщиком услуг доступа (Интернет-провайдером).</p>
...
<p><span>4.   ПРАВА И ОБЯЗАННОСТИ СТОРОН</span></p>
...
<p>4.2.2. Пользоваться всеми имеющимися на Сайте услугами, а также приобретать любые Товары, предлагаемые на Сайте при наличии их на складе у Продавца (Интернет-магазина).</p>

<p>4.2.3. Задавать любые вопросы, относящиеся к услугам Интернет-магазина по тел. 8(918) 33-33-222.</p>
...
<p><span>5.   ИСПОЛЬЗОВАНИЕ САЙТА ИНТЕРНЕТ-МАГАЗИНА</span></p>
...
<p><span>6.   ОТВЕТСТВЕННОСТЬ</span></p>
...
<p>6.2.2. Действия систем переводов, банков, платежных систем и задержки связанные с их работой.</p>
...
<p><span>7.   НАРУШЕНИЕ УСЛОВИЙ ПОЛЬЗОВАТЕЛЬСКОГО СОГЛАШЕНИЯ</span></p>
