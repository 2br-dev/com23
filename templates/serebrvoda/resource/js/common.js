...
/**
        ...
        */
        ...
        incProduct = function() {
            var amountField = $(this).closest(data.options.cartItem).find(data.options.amountField);
            var amountTextField = $(this).closest(data.options.cartItem).find(data.options.amountTextField);
