...
class UserStatusCtrl extends \RS\Controller\Admin\Crud
{
    ...
    {     
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\Text('copy_type', t('Дублирует статус'), array('Sortable' => SORTABLE_BOTH, 'TdAttr' => array('class' => 'cell-sgray'))),
    ...
    public function actionAdd($primaryKeyValue = null, $returnOnSuccess = false, $helper = null)
    {
        ...
        $helper->setTopTitle($primaryKeyValue ? t('Редактировать статус').' {title}' : t('Добавить статус для заказов'));
