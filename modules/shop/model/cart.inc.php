...

{
    ...
    */
     ...
     *
     * @param $session_id ID сессии корзины
     * @param null $site_id ID сайта
     * @return Cart
     */
    public static function userCart($session_id, $site_id = null)
    {
        return new self(self::MODE_SESSION, null, $session_id, $site_id);
    }
