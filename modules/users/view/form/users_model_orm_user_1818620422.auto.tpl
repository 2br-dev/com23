        ...
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none"/>
                        ...
                        <div class="tab-pane" id="users-user-tab1" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__company_ogrn->getTitle()}&nbsp;&nbsp;{if $elem.__company_ogrn->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__company_ogrn->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__company_ogrn->getRenderTemplate() field=$elem.__company_ogrn}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__is_online->getTitle()}&nbsp;&nbsp;{if $elem.__is_online->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__is_online->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__is_online->getRenderTemplate() field=$elem.__is_online}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__forced_offline->getTitle()}&nbsp;&nbsp;{if $elem.__forced_offline->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__forced_offline->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__forced_offline->getRenderTemplate() field=$elem.__forced_offline}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__last_order_time->getTitle()}&nbsp;&nbsp;{if $elem.__last_order_time->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__last_order_time->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__last_order_time->getRenderTemplate() field=$elem.__last_order_time}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__allowed_to_orders->getTitle()}&nbsp;&nbsp;{if $elem.__allowed_to_orders->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__allowed_to_orders->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__allowed_to_orders->getRenderTemplate() field=$elem.__allowed_to_orders}</td>
                                </tr>
                        ...
                        <div class="tab-pane" id="users-user-tab6" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__empty_bottle->getTitle()}&nbsp;&nbsp;{if $elem.__empty_bottle->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__empty_bottle->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__empty_bottle->getRenderTemplate() field=$elem.__empty_bottle}</td>
                                </tr>
                        ...
                        <div class="tab-pane" id="users-user-tab7" role="tabpanel">
                                                                                                            {include file=$elem.__user_address_list->getRenderTemplate() field=$elem.__user_address_list}
                        ...
                        <div class="tab-pane" id="users-user-tab8" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__time_last_activity->getTitle()}&nbsp;&nbsp;{if $elem.__time_last_activity->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__time_last_activity->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__time_last_activity->getRenderTemplate() field=$elem.__time_last_activity}</td>
                                </tr>
