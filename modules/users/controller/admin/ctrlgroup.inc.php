...
class Ctrlgroup extends \RS\Controller\Admin\Crud
{
    ...
    function actionAdd($primaryKeyValue = null, $returnOnSuccess = false, $helper = null)
    {
        ...
        $select_row = array(
            new TableType\Text('title', null, array('TdAttr' => array('colspan' => '3'))),
            new TableType\Usertpl('selectors', t('выбрать все'), "%users%/form/group/quick_select.tpl"),
        );

        $helper['table']->getTable()->insertAnyRow($select_row, 0);
