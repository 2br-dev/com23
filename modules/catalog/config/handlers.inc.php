...
class Handlers extends \RS\Event\HandlerAbstract
{
    ...
    {
        \Users\Model\Orm\User::attachClassBehavior(new \Catalog\Model\Behavior\UsersUser);
    }
    ...
    */
    public static function controllerExecUsersAdminCtrlIndex(\RS\Controller\Admin\Helper\CrudCollection $helper)
    {
        $tpl = '%catalog%/form/user/column_personal_price.tpl';
        $properties = array(
            'cost_list' => \Catalog\Model\CostApi::staticSelectList(),
            'site_list' => \Site\Model\Api::staticSelectList(),
        );
