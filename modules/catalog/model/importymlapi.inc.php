    ...
    */
    ...
    private function importProduct($reader)
    {
        ...
        if ((string) $offer_xml->name){
            $product['title']         = !$this->config['use_htmlentity'] ? (string) $offer_xml->name : htmlspecialchars((string) $offer_xml->name);
        }elseif ((string) $offer_xml->model){
            $product['title']         = !$this->config['use_htmlentity'] ? (string) $offer_xml->model : htmlspecialchars((string) $offer_xml->model);
        }
        ...
        $product['barcode']           = !$this->config['use_htmlentity'] ? (string) $offer_xml->attributes()->vendorCode : htmlspecialchars((string)$offer_xml->attributes()->vendorCode);
