...
class Handlers extends \RS\Event\HandlerAbstract
{
    ...
    public static function cron()
    {
        ...
        foreach($array_of_transaction as $sber_transaction) {
            ...
            if ($transaction['id']) {
                ...
                //file_put_contents(\Setup::$PATH.'/sberlog.txt', "\n".date('Y-m-d H:i:s').' array - '.print_r($transaction, true), FILE_APPEND);
            }
        }         
    }
    ...
    */
    ...
    {        
        ...
        foreach($array_of_transaction as $sber_transaction) {
            $transaction = new \Shop\Model\Orm\Transaction($sber_transaction['transaction_id']);
            //$transaction_url = $transaction->checkSign();
            echo "<pre>";
            ...
            if ($transaction['id']) {
                ...
                $transaction->onResult($request);
                file_put_contents(\Setup::$PATH.'/sberlog.txt', $transaction, FILE_APPEND);
            }
        }        
