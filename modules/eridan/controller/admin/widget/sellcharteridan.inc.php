...
*/
namespace Eridan\Controller\Admin\Widget;

class SellChartEridan extends \Shop\Controller\Admin\Widget\SellChart
{
    protected
        $info_title = 'График продаж - ERIDAN',
    ...
    function init()
    {
        $this->api = new \Eridan\Model\OrderApi();
    }
    ...
    function actionIndex()
    {
        ...
        return $this->result->setTemplate('%eridan%/widget/sellchart.tpl');
    }
