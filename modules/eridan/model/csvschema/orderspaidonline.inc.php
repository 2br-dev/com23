...
*/
namespace Eridan\Model\CsvSchema;
use \RS\Csv\Preset,
...
*/
class OrdersPaidOnline extends \RS\Csv\AbstractSchema
{
    function __construct()
    {
        parent::__construct(new Preset\Base(array(
                ...
                'savedRequest' => \Shop\Model\OrderApi::getSavedRequest('Eridan\Controller\Admin\OrdersPaidOnlineCtrl_list'), //Объект запроса из сессии с параметрами текущего просмотра списка
                'multisite' => true,
